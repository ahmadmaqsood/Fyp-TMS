    ...
    return (
        <div className='min-h-screen w-full bg-[#BDBEC1]'>
            <div className='bg-[#4375AD] h-40  text-white px-11  mb-6 flex flex-col justify-center'>
                ...
                <p className='text-base font-medium'>Information About User</p>
            </div>
            <div className='bg-white w-11/12 -mt-16 mx-auto py-6 rounded-t-md'>
                <h5 className='text-xl text-slate-600 mx-12 mb-3 font-semibold'>Add User</h5>
                <div className="mx-12 ">
                    ...
                    <input type="text" className=" py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600 peer mb-1" placeholder=" Username" />
                    <input type="text" className=" py-2.5 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600 peer mb-1" placeholder=" Password" />
                    ...
                    <form class="w-full mx-auto mb-3">
                        <select id="underline_select" class=" py-2.5 px-1 w-full text-md text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
